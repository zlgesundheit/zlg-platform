...
@Generated(
    ...
    date = "2021-03-26T11:33:18.380621+01:00",
...
public class BloodPressureTrainingSampleObservation implements EntryEntity {
   ...
   * Description: Peak systemic arterial blood pressure over one cycle - measured in systolic
   *                         or contraction phase of the heart cycle
   *                     
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/history/Baseline reading/blood pressure/Systolic/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/history/Baseline reading/blood pressure/Diastolic/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/Baseline reading/Mean Arterial Pressure
   * Description: The average arterial pressure that occurs over the entire course of the
   *                         heart contraction and relaxation cycle. In non-invasive blood pressure measurements the MAP is
   *                         calculated using (2 x Systolic Blood Pressure + Diastolic Blood Pressure) divided by 3.
   *                     
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/history/Baseline reading/blood pressure/Mean Arterial Pressure/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/Baseline reading/Pulse Pressure
   * Description: The difference between the systolic and diastolic pressure over one
   *                         contraction cycle.
   *                     
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/history/Baseline reading/blood pressure/Pulse Pressure/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/history/Baseline reading/blood pressure/Comment/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/history/Baseline reading/state structure/Position/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/Baseline reading/Level of Exertion
   * Description: Details about physical activity undertaken as the blood pressure is
   *                         recorded
   *                     
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/history/Baseline reading/state structure/Tilt/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/Cuff size
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/list structure/Cuff size/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/list structure/Location of measurement/null_flavour
   */
  ...
  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/list structure/Korotkoff sounds/null_flavour
   */
  @Path("/protocol[at0011]/items[at1010]/null_flavour|defining_code")
  private NullFlavour korotkoffSoundsNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/Blood pressure (Training sample)/Device
   * Description: Details about sphygmomanometer or other device used to measure the blood
   *                         pressure
   *                     
   */
