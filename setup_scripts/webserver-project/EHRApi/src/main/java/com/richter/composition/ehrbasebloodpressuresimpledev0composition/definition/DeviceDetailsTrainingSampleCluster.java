...
@Generated(
    ...
    date = "2021-03-26T11:33:18.326765900+01:00",
...
public class DeviceDetailsTrainingSampleCluster implements LocatableEntity {
  ...
  /**
   * Path: Encounter (training sample)/context/Tree/Admin detail/Device details (training sample)/Name/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour nameNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/Description
  ...
  /**
   * Path: Encounter (training sample)/context/Tree/Admin detail/Device details (training sample)/Description/null_flavour
   */
  @Path("/items[at0002]/null_flavour|defining_code")
  private NullFlavour descriptionNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/Manufacturer details/Manufacturer
  ...
  /**
   * Path: Encounter (training sample)/context/Tree/Admin detail/Device details (training sample)/Manufacturer details/Manufacturer/null_flavour
   */
  @Path("/items[at0004]/items[at0003]/null_flavour|defining_code")
  private NullFlavour manufacturerNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/Manufacturer details/Model
  ...
  /**
   * Path: Encounter (training sample)/context/Tree/Admin detail/Device details (training sample)/Manufacturer details/Model/null_flavour
   */
  @Path("/items[at0004]/items[at0005]/null_flavour|defining_code")
  private NullFlavour modelNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/Manufacturer details/Serial number
  ...
  /**
   * Path: Encounter (training sample)/context/Tree/Admin detail/Device details (training sample)/Manufacturer details/Serial number/null_flavour
   */
  @Path("/items[at0004]/items[at0006]/null_flavour|defining_code")
  private NullFlavour serialNumberNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/Components
  ...
  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/Servicing/Date last serviced
  ...
  /**
   * Path: Encounter (training sample)/context/Tree/Admin detail/Device details (training sample)/Servicing/Date last serviced/null_flavour
   */
  @Path("/items[at0008]/items[at0009]/null_flavour|defining_code")
  private NullFlavour dateLastServicedNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/Servicing/Date last calibration
  ...
  /**
   * Path: Encounter (training sample)/context/Tree/Admin detail/Device details (training sample)/Servicing/Date last calibration/null_flavour
   */
  @Path("/items[at0008]/items[at0010]/null_flavour|defining_code")
  private NullFlavour dateLastCalibrationNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/Servicing/Serviced by
  ...
  /**
   * Path: Encounter (training sample)/context/Tree/Admin detail/Device details (training sample)/Servicing/Serviced by/null_flavour
   */
  @Path("/items[at0008]/items[at0011]/null_flavour|defining_code")
  private NullFlavour servicedByNullFlavourDefiningCode;

  /**
   * Path: Encounter (training sample)/context/Admin detail/Device details (training sample)/feeder_audit
   */
  @Path("/feeder_audit")
