package com.schneider.restendpoint.data.ehrbasebloodpressuresimpledev0composition.definition;
...
public class BloodPressureTrainingSampleObservationContainment extends Containment {
  ...
  public SelectAqlField<NullFlavour> SYSTOLIC_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0004]/null_flavour|defining_code", "systolicNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> DIASTOLIC_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0005]/null_flavour|defining_code", "diastolicNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> MEAN_ARTERIAL_PRESSURE_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at1006]/null_flavour|defining_code", "meanArterialPressureNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> PULSE_PRESSURE_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at1007]/null_flavour|defining_code", "pulsePressureNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> COMMENT_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0033]/null_flavour|defining_code", "commentNullFlavourDefiningCode", NullFlavour.class, this);

  public SelectAqlField<PositionDefiningCode> POSITION_DEFINING_CODE = new AqlFieldImp<PositionDefiningCode>(BloodPressureTrainingSampleObservation.class, "/data[at0001]/events[at0002]/state[at0007]/items[at0008]/value|defining_code", "positionDefiningCode", PositionDefiningCode.class, this);

  public SelectAqlField<NullFlavour> POSITION_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/data[at0001]/events[at0002]/state[at0007]/items[at0008]/null_flavour|defining_code", "positionNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> TILT_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/data[at0001]/events[at0002]/state[at0007]/items[at1005]/null_flavour|defining_code", "tiltNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<CuffSizeDefiningCode> CUFF_SIZE_DEFINING_CODE = new AqlFieldImp<CuffSizeDefiningCode>(BloodPressureTrainingSampleObservation.class, "/protocol[at0011]/items[at0013]/value|defining_code", "cuffSizeDefiningCode", CuffSizeDefiningCode.class, this);

  public SelectAqlField<NullFlavour> CUFF_SIZE_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/protocol[at0011]/items[at0013]/null_flavour|defining_code", "cuffSizeNullFlavourDefiningCode", NullFlavour.class, this);

  public SelectAqlField<LocationOfMeasurementDefiningCode> LOCATION_OF_MEASUREMENT_DEFINING_CODE = new AqlFieldImp<LocationOfMeasurementDefiningCode>(BloodPressureTrainingSampleObservation.class, "/protocol[at0011]/items[at0014]/value|defining_code", "locationOfMeasurementDefiningCode", LocationOfMeasurementDefiningCode.class, this);

  public SelectAqlField<NullFlavour> LOCATION_OF_MEASUREMENT_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/protocol[at0011]/items[at0014]/null_flavour|defining_code", "locationOfMeasurementNullFlavourDefiningCode", NullFlavour.class, this);

  public SelectAqlField<KorotkoffSoundsDefiningCode> KOROTKOFF_SOUNDS_DEFINING_CODE = new AqlFieldImp<KorotkoffSoundsDefiningCode>(BloodPressureTrainingSampleObservation.class, "/protocol[at0011]/items[at1010]/value|defining_code", "korotkoffSoundsDefiningCode", KorotkoffSoundsDefiningCode.class, this);

  public SelectAqlField<NullFlavour> KOROTKOFF_SOUNDS_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BloodPressureTrainingSampleObservation.class, "/protocol[at0011]/items[at1010]/null_flavour|defining_code", "korotkoffSoundsNullFlavourDefiningCode", NullFlavour.class, this);
