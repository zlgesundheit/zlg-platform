package com.schneider.restendpoint.data.ehrbasebloodpressuresimpledev0composition;
...
import com.schneider.restendpoint.data.ehrbasebloodpressuresimpledev0composition.definition.BloodPressureTrainingSampleObservation;
import com.schneider.restendpoint.data.ehrbasebloodpressuresimpledev0composition.definition.DeviceDetailsTrainingSampleCluster;
...
public class EhrbaseBloodPressureSimpleDeV0CompositionContainment extends Containment {
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(EhrbaseBloodPressureSimpleDeV0Composition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(EhrbaseBloodPressureSimpleDeV0Composition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);
